    ...
    <BlogContentTemplate>
      ...
      <template #blog-content>
        ...
        <BlogContentSection
            ...
            heading-id="stepsToDevelopDesign"
        >
          <BlogContentBlock
              sub-heading="1. Definition of objectives and goals:"
              sub-heading-id="firstStep"
          >
            <p>First of all, one needs to set clear objectives and goals. Having no clear view of what is to be
              achieved will result in your project losing direction; the step is very essential both for the in-house
              and external design briefs.</p>

            <p><b>In-House Briefs:</b>
              When working with an in-house team, there might not be quite so much of an issue in lining up on
              objectives simply because the team would already know the mission of the organization. It is, however,
              still essential to clearly specify certain project objectives within that framework of the company.</p>

            <p><b>External Briefs:</b>
              When working with external designers, it's essential to provide loads of context about your organization
              and the goals of your projects. This might also include bringing clarity to external teams that are less
              familiar with your brand.</p>

            <p><strong>Well, it all goes back to the answer to these five questions:</strong></p>
            ...
            <p>These would be the skeleton for your design brief and will let you make your objectives specific,
              measurable, relevant, and time-bound.</p>
          </BlogContentBlock>

          <BlogContentBlock
              sub-heading="2. Research and get an insight into your audience:"
              sub-heading-id="secondStep"
          >
            <p>
          ...
          <BlogContentBlock
              ...
              sub-heading-id="thirdStep"
          >
            <p>Define key messages to be communicated and the reinforcement of brand identity, a step one doesn't want
              to miss, whether it's in-house or external briefs.</p>

            <img src="/img/blogs/blog-two/researching.webp" alt="Researching">

            <p><b>In-House Briefs:</b>
              Even when working with your internal team, you need to brief on any updates or specific areas in your
              brand identity.</p>

            <p>
              <b>External Briefs:</b>
              Provide insight into the mission, vision, and values of your brand. Branding guidelines that include
              color schemes, fonts, and imagery will guide consistency.</p>
            ...
            <p>Previous marketing material or campaign to compare and contrast<br>
              This will help designers come up with material consistent with your brand and deliver appropriate
              messages.</p>
          </BlogContentBlock>

          <BlogContentBlock
              sub-heading="4. Clearly spell out deliverables and specifications:"
              sub-heading-id="fourthStep"
          >
            <p>Deliverables should be clearly specified for an internal or external design team. Clearly state what is
              expected to have excellent results.</p>

            <p><b>In-House Briefs:</b>
              Even though in-house designers would have a greater familiarity with the technical specifications, it is
              always best to specify the kind of design required, the dimensions, what file formats are required, and
              other technical requirements.</p>

            <p><b>External Briefs:</b>
              Clearly mention the deliverables with type of design, dimension, resolution, file format, and color
              details. Also, specify style or inspiration, if any.<br>
              Clearly specified guidelines reduce the chances of miscommunication and revisions. Hence, a smoother
              execution of a project.</p>
          </BlogContentBlock>

          <BlogContentBlock
              sub-heading="5. Define the Project Timeline and Budget:"
              sub-heading-id="fifthStep"
          >
            <p>Well-defined scope of time and budget helps to keep everything on track.</p>

            <p><b>In-House Briefs:</b>
              While internal projects may have more flexibility with budgets and timelines, realistic budgeting and
              scheduling for projects is still very critical for resource and expectation management.</p>

            <p><b>External Briefs:</b>
              Clearly spell out the timeline by which different phases will be completed, indicating milestones and
              deadlines. Be very clear as to what is expected of cost parameters.<br>
              Spell out a contingency plan in case of last-minute changes or expenses that are off-track.</p>
          </BlogContentBlock>
        </BlogContentSection>

        <BlogContentSection
            heading="Differences between an In-House and an External Design Brief"
            heading-id="differencesInDesign"
        >
          <p>Knowing the differences between in-house and external design briefs can help one tailor his approach
            accordingly:</p>

          <p><b>In-House Briefs:</b>
            Familiarity with the brand, ongoing collaboration, easier communication, more control over resources.</p>

          <p><b>External Briefs:</b>
            A fresh perspective, specialized expertise, unbiased views, and scaled resources. An external designer
            brings valuable experience and creativity to the table.<br>
            <b class="italic">Top Tip:</b> You may want to use a design brief template to make things easier. We have a
            really in-depth, comprehensive creative brief template you can use to get started.</p>

          <p>Making Sure Your Content Matches the Design Brief<br>
            Technology is here to help make your design process easier. DevDock design approval software helps you
            manage feedback and approvals fast and conveniently. With DevDock, you have the possibility to set up
            overviews of projects, invite reviewers, share designs easily, etc.</p>

          <BlogContentBlock
              sub-heading="Key features include:"
              sub-heading-id="keyFeatures"
          >
